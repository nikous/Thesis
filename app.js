...
// Take Stocks name from client, calls Api and send response to client
// Weekly
...
app.get('/getAp/:symbol', async (request, response) => {
  ...
  console.log('2_', request.params.symbol);
